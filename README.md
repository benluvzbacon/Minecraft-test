...
4. **Follow a Rift signal.** Right-click the Rift Compass in the Overworld. It reports the nearest generated structure signal's **X/Z coordinates, approximate distance, and direction**, and sends a particle trail toward it. The locator can discover structures in unexplored terrain. It is intentionally a coordinate locator, **not a rotating compass needle**.
