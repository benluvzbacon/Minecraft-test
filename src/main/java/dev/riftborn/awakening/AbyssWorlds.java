...
public final class AbyssWorlds {
    ...
    public static TagKey<Structure> sites(String name) { return TagKey.of(RegistryKeys.STRUCTURE, Riftborn.id("awakening/" + name)); }
    public static boolean isRealm(World world) { return world.getRegistryKey().equals(ABYSS) || world.getRegistryKey().equals(RiftDimensions.WORLD); }
    private AbyssWorlds() { }
}
